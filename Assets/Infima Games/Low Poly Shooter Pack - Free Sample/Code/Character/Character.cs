...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public sealed class Character : CharacterBehaviour
    {
        ...
        [Header("Inventory")] [Tooltip("Inventory.")] [SerializeField]
        private InventoryBehaviour inventory;

        [Header("Cameras")] [Tooltip("Normal Camera.")] [SerializeField]
        private Camera cameraWorld;

        [Header("Animation")] [Tooltip("Determines how smooth the locomotion blendspace is.")] [SerializeField]
        ...
        [Header("Animation Procedural")] [Tooltip("Character Animator.")] [SerializeField]
        ...
        /// Last Time.time at which we shot.
        /// </summary>
        private float lastFiredEmptyTime;
        ...
        protected override void Update()
        {
            ...
            {
                //Check.
                if (CanPlayAnimationFire() && equippedWeapon.IsAutomatic())
                {
                    ...
                    {
                        // fire empty in a slower rate
                        if (Time.time - lastFiredEmptyTime > 60.0f / (equippedWeapon.GetRateOfFire() / 4))
                        {
                            FireEmpty();
                        }
                    }
        ...
        private void UpdateAnimator()
        {
            ...
            characterAnimator.SetFloat(HashAimingAlpha, Convert.ToSingle(aiming), 0.25f / 1.0f * dampTimeAiming,
                Time.deltaTime);
