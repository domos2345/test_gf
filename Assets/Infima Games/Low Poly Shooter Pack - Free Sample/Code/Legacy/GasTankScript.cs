...
public class GasTankScript : MonoBehaviour
{
    ...
    [Header("Light")] public Light lightObject;

    [Header("Particle Systems")] public ParticleSystem flameParticles;
    public ParticleSystem smokeParticles;

    [Header("Audio")] public AudioSource flameSound;
    ...
    private IEnumerator Explode()
    {
        ...
        upgradeOrbHolder.DropRandomOrb(transform.position);
        Destroy(gameObject);
    }
}